...
const StateCard = ({id, imageUrl, state} : StateCardType) => {
  return (
    <div className='transition-transform duration-200 hover:scale-110 ease-in-out flex flex-col items-center'> 
      {id % 2 === 0 && 
      ...
      <div className='absolute bottom-0 left-0 w-full bg-linear-to-t h-13.5 from-white/70 to-transparent'></div>
